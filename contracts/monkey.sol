...
contract Monkey is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Innovation for protocol by MONKEY Team
    ...
    uint256 public _liquidityFee = 9; // 3% will be added pool, 3% will be converted to BNB
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _teamReward = 30;
